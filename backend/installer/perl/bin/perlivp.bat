...
#!perl
#line 29
    eval 'exec C:\Users\bhatl\OneDrive\Scans\Desktop\installer\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\bhatl\OneDrive\Scans\Desktop\installer\perl\bin\perl.exe';
